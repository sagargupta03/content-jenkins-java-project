	...
	stages
	{
      ...
      steps {
		...
		stage('Deploy')
		{
			...
			sh " sudo cp su/var/lib/jenkins/workspace/Jenkins Practice 1/Ant-Project-Demo-Ketan-Assignment/dist/rectangle_${env.MAJOR_VERSION}.${env.BUILD_NUMBER}.jar /var/www/html/rectangles/all/${env.BRANCH_NAME}/" 	
		      }
		}
